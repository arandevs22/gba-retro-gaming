...
export const Cartas = () => {
    ...
    const { gamesCartas } = useLoaderData();
...
export const loaderCartas = async () => {
    const res = await fetch(`https://apiretrogame-production.up.railway.app/api/games/game-boy-advance/cartas/`);
    const gamesCartas = await res.json();
