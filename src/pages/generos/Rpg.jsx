...
export const loaderRpg = async () => {
    const res = await fetch(`https://apiretrogame-production.up.railway.app/api/games/game-boy-advance/rpg/`);
    const gamesRpg = await res.json();
